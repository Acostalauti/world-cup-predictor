...
const AdminReports = () => {
  ...
  const r = reports || {
    users: { total: 0, verified: 0, admins: 0, newThisWeek: 0, activeToday: 0, retentionRate: 0 },
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <div className="flex items-center text-xs text-green-600">
                ...
                {r.users.newThisWeek > 0 ? `+${r.users.newThisWeek} esta semana` : "Sin cambios"}
              </div>
            </CardContent>
          </Card>
          <Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-muted-foreground">Nuevos usuarios esta semana</span>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold">{r.users.admins.toLocaleString()}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
